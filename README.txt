...
The markdown-file is dynamically reproducible and sources all relevant files, including downloading the different datasets. Note, however, it is computational demanding and can take 15-25 minutes. To easy computation, each of the data-generation files saves a dataset after their first run, and if they are present in the "data" folder, the markdown-file simply loads the final dataset rather than re-downloading and transforming them. 
