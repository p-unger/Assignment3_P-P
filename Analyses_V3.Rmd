...
```{r, fig1,warning=FALSE,echo=FALSE,fig.cap="Life- and Work-Satisfaction"}
...
```{r, fig4,fig.heigth=5,warning=FALSE,echo=FALSE,fig.cap="Work-hours of Full-Time Workers"}
par(mfrow=c(1,1)) 
satjob_dist <- table(z$satjob)/sum(table(z$happy))*100
...
```{r, fig5,fig.heigth=5,warning=FALSE,echo=FALSE,fig.cap="Happiness levels for college educated men and women depending on labour-market affiliation"}
...
```{r, fig6,fig.width=3,warning=FALSE,echo=FALSE,fig.cap="Happiness depending on income status"}

z = z[z$year >= 1977 & z$year < 2012,]

  # Here we follow Bertrand (2013). The number of people with income "Not                                    # Applicable" is substantial but the respective people are unlikely to                                     # have a high income so treating them as career=0 appears valid.
...
```{r, fig8,warning=FALSE,echo=FALSE,Cache=TRUE,fig.cap="Interaction effects of being married and high-income job on life satisfaction"}
